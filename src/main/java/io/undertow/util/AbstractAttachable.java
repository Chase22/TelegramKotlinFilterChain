...
//2020-09-08 added @SuppressWarnings("unchecked") annotations to all methods
/**
...
public abstract class AbstractAttachable implements Attachable {
    ...
    public <T> T putAttachment(final AttachmentKey<T> key, final T value) {
        if (key == null) {
            //2020-09-08: Replace UndertowMessages.MESSAGES.argumentCannotBeNull("key") call with an IllegalArgumentException
